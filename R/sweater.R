...
#' @param w a numeric matrix of word embeddings, e.g. from [read_word2vec()]
...
#' @return A list with class `"weat"` containing the following components:
...
#' [weat_es()] can be used to obtain the effect size of the test; [weat_resampling()] for a test of significance.
#' @examples
...
#' @param x an object from the [weat] function.
